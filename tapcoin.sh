...
echo -e "${GREEN}TapCoins 봇을 설치합니다.${NC}"
echo -e "${GREEN}스크립트작성자: https://t.me/kjkresearch${NC}"
echo -e "${GREEN}출처: https://github.com/Bachtran301/TapCoins${NC}"

echo -e "${GREEN}설치 옵션을 선택하세요:${NC}"
echo -e "${YELLOW}1. TapCoins 봇 새로 설치${NC}"
echo -e "${YELLOW}2. 재실행하기${NC}"
read -p "선택: " choice

case $choice in
  1)
    echo -e "${GREEN}TapCoins 봇을 새로 설치합니다.${NC}"
    ...
    git clone https://github.com/Bachtran301/TapCoins
    cd "$WORK"
    ...
    read -p "애플리케이션-세션저장소-TapCoins와 관련된 URL클릭 후 나오는 UserID나 QueryID를 적어두세요 (엔터) : "
  ...
  2)
    echo -e "${GREEN}TapCoins 봇을 재실행합니다.${NC}"
